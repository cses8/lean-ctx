...
fn run_mcp_server() -> Result<()> {
    ...
    rt.block_on(async {
        ...
        tracing::info!("lean-ctx v2.16.3 MCP server starting");
...
fn print_help() {
    println!(
        "lean-ctx 2.16.3 — The Intelligence Layer for AI Coding
...
fn print_gain_with_logo() {
    ...
    println!("  {d}lean-ctx v2.16.3  |  leanctx.com  |  lean-ctx dashboard{r}");
    println!();
